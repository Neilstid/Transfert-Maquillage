...
# Data settings
_C["DATA"] = dict()
_C["DATA"]["PATH"] = r'C:\Users\Neil\OneDrive - Professional\Documents\Python scripts\EleGANt-main\data\MT-Dataset'
...
_C["LOSS"]["LAMBDA_REC"] = tune.uniform(4, 16) # 10
_C["LOSS"]["LAMBDA_MAKEUP"] = tune.uniform(50, 150) # 100
_C["LOSS"]["LAMBDA_SKIN"] = tune.uniform(0.01, 1) # 0.1
_C["LOSS"]["LAMBDA_EYE"] = tune.uniform(1, 2) # 1.5
_C["LOSS"]["LAMBDA_LIP"] = tune.uniform(0.5, 2) # 1
...
if _C["PGT"]["TYPE"] == 3:
    ...
    _C["LOSS"]["LAMBDA_C_GT"] = tune.uniform(0.1, 2)
    _C["LOSS"]["LAMBDA_C_D"] = tune.uniform(0.1, 2)
